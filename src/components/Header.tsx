...
import Logo from '/e-servis-arancio2.png';
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-500 right-0 z-50 bg-dark-bg/80 backdrop-blur-lg border-b border-dark-bg-tertiary">
